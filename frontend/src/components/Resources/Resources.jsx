  ...
  return (
    <div align="center">
      ...
      <Typography variant="body1">
        If you are an individual, LUM (Lafayette Urban Ministry) is the primary
        shelter in Greater Lafayette. <br /> They accept registration on
        weekdays between 7 – 11 am and 6-7 am on Saturdays. <br /> If you
