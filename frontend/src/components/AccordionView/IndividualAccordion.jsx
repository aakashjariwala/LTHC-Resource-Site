      ...
      <Accordion>
        ...
        <AccordionDetails>
          ...
          <Typography>
            ...
            registration on weekdays between 7 – 11 am and 6-7 am on Saturdays.{' '}
            <br /> If you receive a bed with LUM, check will be 9 pm that
            evening. <br /> Their address for check in is 420 North 4th Street
            and the actual shelter is at 520 North 4th.
          </Typography>
        </AccordionDetails>
      </Accordion>
    </div>
